...
public class ImprovedLogging {
    public static void main(String[] args) {

        System.Logger logger = System.getLogger(ImprovedLogging.class.getName());
        ...
        Logger LOGGER = Logger.getLogger(ImprovedLogging.class.getName());
